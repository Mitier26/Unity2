...
public class Rotate : MonoBehaviour
{
    ...
    [SerializeField] private float rotateTime, maxAngle;
    ...
    private IEnumerator IRotate()
    {
        ...
        float timeElapsed = 0;
        float timeToComplete = Random.Range(0.75f, 1.25f) * rotateTime;
        float angle = Random.Range(0.75f, 1.25f) * maxAngle;
        ...
        while(!isGameFinished)
        {
            ...
            timeElapsed = 0;
            timeToComplete = Random.Range(0.75f, 1.25f) * rotateTime;
            angle = Random.Range(0.75f, 1.25f) * maxAngle;
