...
public class GameManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        Vector3 cameraPos = pathCreator.path.GetPointAtDistance(distanceTravelled);
        cameraPos += (localUp * 4f - direction * 8f);
    ...
    private void CreatPath()
    {
        ...
        Vector3 normal = pathCreator.path.GetNormal(num - 1);
        ...
        Vector3 tempOffset = Random.Range(-maxSpawnRadius, maxSpawnRadius) * normal + Random.Range(-maxSpawnRadius, maxSpawnRadius) * localUp;
        ...
        while(obstacleDistance < pathCreator.path.length)
        {
            ...
            tempObstacle.GetComponentInChildren<TMP_Text>().text = ((int)((obstacleDistance - obstacleSpawnStartDistance)/(offset * 2f))).ToString();
