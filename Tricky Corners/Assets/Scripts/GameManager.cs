...
public class GameManager : MonoBehaviour
{
    ...
    private void UpdateScorePrefab()
    {
        ...
        Vector3 offset = spawnPos[(spawnIndex + 1) % spawnPos.Length] - spawnPos[spawnIndex] ;
        Vector3 temp = spawnPos[spawnIndex] + pos * offset;
        Instantiate(pointPrefab, temp, pointPrefab.transform.rotation);
    }
