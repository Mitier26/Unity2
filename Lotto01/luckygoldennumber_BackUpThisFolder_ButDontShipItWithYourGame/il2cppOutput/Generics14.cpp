...
{
	{
		...
		L_0 = Dictionary_2_get_Keys_m85554366576478DEF4E6716C6028AEDFCF67D30C(__this, il2cpp_rgctx_method(method->klass->rgctx_data, 55));
		return (RuntimeObject*)L_0;
	}
}
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR RuntimeObject* Dictionary_2_System_Collections_IDictionary_get_Item_m00219CFAF42CC69CB3056C35DB77B3A63BD7ACA7_gshared (Dictionary_2_t66703E5B5DAC871FEE58F3ED3A50BC6863FC12DC* __this, RuntimeObject* ___key0, const RuntimeMethod* method) 
{
	...
	}
	{
		RuntimeObject* L_2 = ___key0;
		int32_t L_3;
		L_3 = Dictionary_2_FindEntry_m956C6EBC2315A809138FA4C69D18B8AB43CB08D1(__this, ((*(int32_t*)((int32_t*)(int32_t*)UnBox(L_2, il2cpp_rgctx_data(method->klass->rgctx_data, 14))))), il2cpp_rgctx_method(method->klass->rgctx_data, 28));
		V_0 = L_3;
		int32_t L_4 = V_0;
		if ((((int32_t)L_4) < ((int32_t)0)))
		{
