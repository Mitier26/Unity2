...
{
	{
		...
		L_0 = Dictionary_2_get_Keys_m0BC7D2803C0FD206460EF89769679ED0DEFA2110(__this, il2cpp_rgctx_method(method->klass->rgctx_data, 55));
		return (RuntimeObject*)L_0;
	}
}
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR RuntimeObject* Dictionary_2_System_Collections_IDictionary_get_Item_mEB4007547ED969CC1839A52EA7E6B8A6976B424A_gshared (Dictionary_2_t91C6CE9606BDA85C77443D05E3B9D8CAB951172E* __this, RuntimeObject* ___key0, const RuntimeMethod* method) 
{
	...
	}
	{
		RuntimeObject* L_2 = ___key0;
		int32_t L_3;
		L_3 = Dictionary_2_FindEntry_mAC4201DF96C26CA7036113E193B0167D39017CA8(__this, ((*(int32_t*)((int32_t*)(int32_t*)UnBox(L_2, il2cpp_rgctx_data(method->klass->rgctx_data, 14))))), il2cpp_rgctx_method(method->klass->rgctx_data, 28));
		V_0 = L_3;
		int32_t L_4 = V_0;
		if ((((int32_t)L_4) < ((int32_t)0)))
		{
