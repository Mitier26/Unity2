...
{
	{
		...
		L_0 = Dictionary_2_get_Keys_mDAFED3FD44CE2DC193DCAF6600607907404C6628(__this, il2cpp_rgctx_method(method->klass->rgctx_data, 55));
		return (RuntimeObject*)L_0;
	}
}
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR RuntimeObject* Dictionary_2_System_Collections_IDictionary_get_Item_mCEF3627D495370EB8E0AF8DC4EB0AFDFA57137C8_gshared (Dictionary_2_t06F13A62631EF131A5D9922F1851E4211F417C59* __this, RuntimeObject* ___key0, const RuntimeMethod* method) 
{
	...
	}
	{
		RuntimeObject* L_2 = ___key0;
		int32_t L_3;
		L_3 = Dictionary_2_FindEntry_m654D3DB2C9C2384396376177EE398FEFA30B123A(__this, ((RuntimeObject*)Castclass((RuntimeObject*)L_2, il2cpp_rgctx_data(method->klass->rgctx_data, 14))), il2cpp_rgctx_method(method->klass->rgctx_data, 28));
		V_0 = L_3;
		int32_t L_4 = V_0;
		if ((((int32_t)L_4) < ((int32_t)0)))
		{
