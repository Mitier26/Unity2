...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] List<Vector3> obstacleSpawnPos;
    ...
    private IEnumerator ISpawnObstacle()
    {
        ...
        Vector3 spawnPos = obstacleSpawnPos[UnityEngine.Random.Range(0, obstacleSpawnPos.Count)];
        ...
        while (!hasGameEnded)
        {
            ...
            spawnPos = obstacleSpawnPos[UnityEngine.Random.Range(0, obstacleSpawnPos.Count)];
